...
class TestFile_Test:
    ...
    def test_display_list(self):
        test = File_test("test_helper.txt")
        assert test.display_list() == ([['Test1', 'przyklad', 'przykladowe', 'przyklady', 'test33'], ['Test2', 'Witam', 'Pozdrawiam']], [['przyklad', 'przykladowe > Siema', 'przyklady', 'test33'], ['Witam', 'Pozdrawiam']])
